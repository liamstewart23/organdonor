<!-- <section id="learn">
	<h2 class="hidden">Learn more about organ donation</h2>
	<div class="row">
	...
	<div class="row" id="pageContent">
		<div class="col-xs-12 col-sm-offset-0 col-md-6 col-md-offset-1 about-main"><br><br><br>
			...
			<h3>Chantry Island is located on Lake Huron, just over a mile southwest of the Saugeen River mouth in Southampton, Ontario.</h3><br>
			<p>On the island is a majestic Imperial Lighthouse built in the mid 1800’s, as w
			ell as the Keeper’s quarters and a boat house. In 1822, during a hydrographic survey, Captain Henry Bayfield of the Royal Navy christened the island and named it after his friend and British sculptor Sir Francis Chantry.</p>
			...
			<h3>For almost 100 years (1859 – 1954), light keepers lived on the island to keep the light burning for mariners on the lake. </h3><br>
			<p>When the lighthouse lamp was converted to electricity in 1954, a light keeper was no longer needed. The buildings were left neglected and suffered at the hands of vandals. The lighthouse still stood intact, but little was left of the light keeper’s quarters. The roof had fallen in and the walls and floors had crumbled into a pile of rubble in the basement.</p>
			<p>In 1997, the local Marine Heritage Society established specific goals for the island’s restoration. The project was to be funded with donations and fundraising efforts, and the majority of the work was to be done by volunteers. With permission from 5 levels of government, the group of volunteers began to rebuild the light keeper’s cottage, using the original structure plans. </p>
