...
Let’s fix that.</p>	
			...
			<div class="col-xs-12 col-sm-offset-0 col-md-6" id="mobileLearnBannerFix">
					<a href="#statistics" target="_self" class="btnB1" id="btnLearnStats">statistics</a>
			</div>
			<div class="col-xs-12 col-sm-offset-0 col-md-6">
					<a href="#myths" target="_self" class="btnB2" id="btnLearnMyths">myth vs. fact</a>
			</div>
		</div>
	</div>
	...
	<div class="col-xs-12 col-md-12 col-md-6 col-md-offset-3 text-center" id="statistics">
		...
		<h4>Organ Donation Statistics</h4>
