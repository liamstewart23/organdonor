	...
	<?php
		...
		if(!is_string($getFacts)){
			while($row = mysqli_fetch_array($getFacts)){
				if ($offset == 1) {
				echo "<div class=\"col-xs-12 col-md-12 myth-fact-bg-offset\"><div class=\"col-xs-12 col-md-10 col-md-offset-1 myth-fact\">
				...
				echo "<div class=\"col-xs-12 col-md-12 myth-fact-bg\"><div class=\"col-xs-12 col-md-10 col-md-offset-1 myth-fact myth-fact-bg\">
							<h3 class=\"red\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i> {$row['mf_myth']}</h3>
							<p><i class=\"fa fa-check green\" aria-hidden=\"true\"></i> {$row['mf_fact']}</p>
					</div></div>";
					$offset = 1;			
