...
(1, 'Mar_30_2017_163458.svg', 'One donor can save up to 8 lives through organ donation, and 75 more through tissue donation.'),
(2, 'Mar_30_2017_163522.svg', 'Over 1500 Ontarians, of all ages, are waiting for an organ donor.'),
(3, 'Mar_30_2017_163532.svg', 'Every three days, one person dies waiting for an organ donation.'),
(4, 'Mar_30_2017_163546.svg', '85% of Ontarians agree with organ donation, but only 31% are actually registered donors.');
...
CREATE TABLE `tbl_stories` (
  ...
  `story_link` varchar(300) NOT NULL,
...
--
ALTER TABLE `tbl_myths_facts`
  MODIFY `mf_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
